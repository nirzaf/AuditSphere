...
public sealed class AuthorizationDecisionTests
{
    ...
    : AuditSphereOps.Application.Operations.IAuditSphereDbContext
  {
    ...
    public DbSet<AuditSphereOps.Domain.Accounting.StatementLayoutVersion> StatementLayoutVersions => db.StatementLayoutVersions;
    public DbSet<AuditSphereOps.Domain.Accounting.StatementLayoutLine> StatementLayoutLines => db.StatementLayoutLines;
    ...
    public DbSet<AuditSphereOps.Domain.Accounting.FinancialPackageFxEffect> FinancialPackageFxEffects => db.FinancialPackageFxEffects;
    public DbSet<AuditSphereOps.Domain.Accounting.FinancialPackageSeal> FinancialPackageSeals => db.FinancialPackageSeals;
    ...
    public DbSet<AuditSphereOps.Domain.Documents.PbcCommunication> PbcCommunications => db.PbcCommunications;
    ...
    public DbSet<AuditSphereOps.Domain.Audit.MaterialityApproval> MaterialityApprovals => db.MaterialityApprovals;
    ...
    public DbSet<AuditSphereOps.Domain.Audit.AnalyticalReviewVarianceInvestigation> AnalyticalReviewVarianceInvestigations => db.AnalyticalReviewVarianceInvestigations;
