...
AuditSphereOps provides native, production-grade implementations for the complete Record-to-Report (R2R) lifecycle defined under `docs/AuditSphere_R2R_Task_Breakdown`:
...
│   ├── AuditSphereOps.Infrastructure/  # EF Core DbContext, PostgreSQL mappings, 96 migrations, document renderers
...
# 2. Verify EF Core model changes against the 96 migrations
