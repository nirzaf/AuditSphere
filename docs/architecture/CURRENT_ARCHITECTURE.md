...
- **Commands and queries are static capability services** returning `CommandResult` /
  ...
  `docs/AuditSphere_R2R_Task_Breakdown/reference/01_Baseline_Architecture_and_ADRs.md` §2.3.1).
...
Use [`CODE_MAP.md`](CODE_MAP.md) to find the Domain/Application/Infrastructure/Web/tests files
