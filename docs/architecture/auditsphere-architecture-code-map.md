...
(`docs/AuditSphere_R2R_Task_Breakdown/modules/auditsphere-r2r-module-26-consolidation-contract.md`).
...
| Capability | Canonical document path | Document purpose | Authority / status | Related implementation area |
|---|---|---|---|---|
| System Specification | `docs/auditsphere-requirements-system-specification-current.md` | Core architecture, data model, business rules, and acceptance criteria | CURRENT | All capabilities / whole platform |
| Current Architecture | `docs/architecture/auditsphere-architecture-current-architecture.md` | Implemented modular monolith architecture, physical organization, authority model | CURRENT | All capabilities |
| Code Map | `docs/architecture/auditsphere-architecture-code-map.md` | Capability-to-file directory and navigation map for human and AI developers | CURRENT | All capabilities |
| Documentation Naming Policy | `docs/architecture/auditsphere-architecture-document-naming-policy.md` | Standard markdown naming rules, allowed vocabulary, and validation rules | CURRENT | All documentation |
| Accounting Roadmap | `docs/auditsphere-accounting-module-requirements-current.md` | Accounting gap analysis, user stories AC-01..AC-28, and implementation roadmap | CURRENT | `Application/Accounting/` |
| R2R Task Breakdown Index | `docs/AuditSphere_R2R_Task_Breakdown/auditsphere-r2r-index-task-breakdown.md` | Master index of 75 numbered tasks across 21 work packages | CURRENT | `AuditSphere_R2R_Task_Breakdown/` |
| M365 Onboarding Stories | `docs/auditsphere-m365-onboarding-user-stories.md` | Simple M365 onboarding and consent user journeys | PROPOSED | `Application/Microsoft365/` |
| Prototype Parity Stories | `docs/auditsphere-audit-user-stories-prototype-gap-closure-proposed.md` | Prototype parity and gap-closure user stories backlog | PROPOSED | `Application/Audit/` |
| R2R Blueprint Source | `docs/AuditSphere_R2R_Task_Breakdown/source/auditsphere-r2r-source-blueprint-modules-20-26-historical.md` | Preserved original R2R blueprint requirements for Modules 20–26 | HISTORICAL_SOURCE | `Application/Accounting/` |
| Audit Workflow Source | `docs/AuditSphere_R2R_Task_Breakdown/source/auditsphere-audit-source-workflow-gap-closure-user-stories-historical.md` | Preserved original audit workflow gap-closure requirements | HISTORICAL_SOURCE | `Application/Audit/` |
| Methodology Approval | `docs/evidence/auditsphere-evidence-approval-methodology-ste-meth-app-001-approved.md` | Firm methodology approval for IFRS, templates, and baseline accounting methods | APPROVED | Accounting and Audit methodologies |
| Methodology Addendum | `docs/evidence/auditsphere-evidence-approval-methodology-ste-meth-app-001-addendum-approved.md` | Methodology addendum extending approval to advanced consolidation and FX | APPROVED | Consolidation and FX translation |
| E2E Testing Strategy | `docs/testing/auditsphere-testing-e2e-automation-strategy.md` | Playwright end-to-end automation strategy and test suites | CURRENT | `tests/AuditSphereOps.E2E.Tests/` |
| Test Case Catalog | `docs/testing/auditsphere-testing-test-case-catalog.md` | Complete inventory of unit, integration, and E2E test cases | CURRENT | `tests/` |
| Active Slice Ledger | `docs/execution/auditsphere-execution-current-slice.md` | Verified local state, active vertical slice notes, and operational runbook | CURRENT | Repository execution |
| Execution Checklist | `docs/execution/auditsphere-execution-implementation-checklist.md` | Cross-module implementation and verification checklist | CURRENT | Repository execution |
| Pending Tasks | `docs/execution/auditsphere-execution-pending-tasks.md` | Ordered implementation backlog of remaining work packages (P0–P10) | CURRENT | Repository execution |
| Database Restore Runbook | `docs/execution/auditsphere-execution-runbook-restore-drill.md` | Local loopback restore drill procedure and verification notes | CURRENT | `scripts/db/` |
| Connection Capacity Decision | `docs/operations/auditsphere-operations-decision-connection-capacity.md` | PostgreSQL connection pooling evaluation and PgBouncer boundary | CURRENT | Infrastructure persistence |
| Telemetry Guide | `docs/operations/auditsphere-operations-guide-telemetry.md` | OpenTelemetry ActivitySource and Meter diagnostic configuration | CURRENT | Web and Worker hosts |
