[Master index](../auditsphere-r2r-index-task-breakdown.md) · [Original module in source](../source/auditsphere-r2r-source-blueprint-modules-20-26-historical.md#module-24)
...
**Statement scope:** financial position; profit or loss and other comprehensive income in the applicable one/two-statement presentation; changes in equity; cash flows; notes; comparative information and an opening comparative financial position where the selected framework requires it. Avoid treating “BS/P&L” labels as the entire reporting obligation. [S6](../reference/auditsphere-r2r-reference-standards-and-source-register.md#source-s6)
...
Reconcile `Opening cash + operating + investing + financing + FX effect on cash = Closing cash`. Noncash investing/financing items are separately disclosed, not counted as cash. An indirect schedule needs supported movements/adjustments to distinguish working capital, acquisitions, FX, noncash changes and reclassifications. The edition controls the starting profit subtotal and interest/dividend classification. [S2](../reference/auditsphere-r2r-reference-standards-and-source-register.md#source-s2)
