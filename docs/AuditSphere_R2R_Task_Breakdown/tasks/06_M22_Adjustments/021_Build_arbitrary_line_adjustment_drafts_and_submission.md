...
updated_at: ""
---
# T021 — Build arbitrary-line adjustment drafts and submission
...
Create explicit source-bound adjustment journals with valid arbitrary debit/credit lines.
...
- [T020 — Build opening completeness proofs and scoped source exports](../05_M21_GL_Mapping/020_Build_opening_completeness_proofs_and_scoped_source_exports.md)
...
1. Reuse existing AdjustmentJournal/Line IDs and state compatibility; bind exact context/base source/purpose/origin.
2. Implement draft editing and submit-time line, account, dimension, currency and exact-balance invariants.
3. Preserve evidence/finding/workpaper links without treating a free-text reference as authorization.
4. Build register/header/grid/editor with stable draft line IDs, local balance preview and server submission outcomes.
...
- Source-bound journal drafts/submissions and detail/register DTOs.
- Journal editor and exact six-decimal balance validation.

**Direct consumers unlocked by this task:**

- [T022 — Implement adjustment decisions, revisions and reversals](022_Implement_adjustment_decisions_revisions_and_reversals.md)
...
- At least two lines, one positive debit or credit per line and exact balance are enforced.
- Cross-client accounts, unsupported purposes and unknown base sources are denied.
- Client/firm source ledgers remain unchanged.
...
**Related integration journeys:** [R2R-AT-01](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-01), [R2R-AT-02](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-02), [R2R-AT-11](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-11).
