...
updated_at: ""
---
# T025 — Implement reconciliation proof and correction-journal handoff
...
Explain ledger and supporting balances without silently posting or counting a correction twice.
...
- [T024 — Build reconciliation schedules and typed source items](024_Build_reconciliation_schedules_and_typed_source_items.md)
...
1. Connect a correction item to the separate Module 22 journal workflow; Module 23 cannot approve the AJE.
2. Calculate reproducible raw/explained ledger and supporting balances from exact current inputs.
3. Apply the approved correction-inclusion rules for raw versus already-adjusted ledger basis.
4. Expose included/excluded corrections, residual and blockers in a proof panel with drill-down.
...
- Versioned reconciliation proof and Module 22 correction link.
- Transparent residual/calculation DTO and UI.

**Direct consumers unlocked by this task:**

- [T026 — Implement reconciliation review, rework and export](026_Implement_reconciliation_review_rework_and_export.md)
...
- GOLD-R2R-03 reconciles both sides to 9,900 with zero residual.
- A fee already included in adjusted TB is not added again.
- Unresolved reflection/correction treatment remains visible and blocks final readiness.
...
|---|---|
| VP-039-AC01 | Given valid schedule items, when recalculated, then opening/source/supporting totals and unexplained residual are reproducible from displayed inputs. |
...
**Related integration journeys:** [R2R-AT-11](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-11), [R2R-AT-12](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-12), [R2R-AT-13](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-13).

**Golden fixtures:** [GOLD-R2R-03](../../coverage/04_Golden_Fixture_Tracking.md#gold-r2r-03). Fixture use requires the original policy approval; the numbers are synthetic QA values.
