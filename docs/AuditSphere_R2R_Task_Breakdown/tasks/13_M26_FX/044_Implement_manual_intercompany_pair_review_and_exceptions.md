...
updated_at: ""
---
# T044 — Implement manual intercompany pair review and exceptions
...
Record supported intercompany relationships and retain unmatched differences for human resolution.
...
- [T043 — Implement rate policies and reproducible FX translation](043_Implement_rate_policies_and_reproducible_FX_translation.md)
...
1. Resolve seller/buyer/source line identities and approved original/translated amount basis.
2. Persist bounded matched amount, currencies, rationale and exact scope/rate/component dependencies.
3. Expose original/translated sides, unmatched values and evidence links in a manual comparison view.
4. Hand reviewed relationships to group-journal authoring without automatically creating/approving a matching journal.
...
- Intercompany pairs/exceptions and exact source-consumption references.
- Manual comparison UI for elimination preparation.

**Direct consumers unlocked by this task:**

- [T045 — Build balanced elimination journals and independent review](../14_M26_Output/045_Build_balanced_elimination_journals_and_independent_review.md)
...
- Unmatched amounts remain visible; no unexplained plug is generated.
- Unsupported counterparties, overlaps or cross-scope inputs are rejected.
- Rate/component/perimeter changes invalidate affected pair applicability.
...
|---|---|
| VP-045-AC03 | Unmatched intercompany amounts remain visible for human resolution; approval does not hide the difference by netting an unexplained plug. |

**Related original stories:** `VP-045`. [Full preserved wording and production interpretation](../../reference/08_Original_52_Acceptance_Criteria.md).

**Related integration journeys:** [R2R-AT-23](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-23), [R2R-AT-24](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-24), [R2R-AT-25](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-25).
