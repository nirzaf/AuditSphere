...
updated_at: ""
---
# T018 — Build resumable GL intake and journal drill-down
...
Extend shared import sessions to real GL transactions and preserve source-line/journal provenance.
...
- [T017 — Seal and accept TB revisions with replacement protection](../04_M21_TB/auditsphere-r2r-task-t017-seal-accept-tb-revisions.md)
...
1. Reuse T015–T017 requests and adapters; add GL-specific profile/transaction validation without duplicating their command ownership.
2. Preserve current GL transaction/line/chunk ceilings and stable journal/line identities; require contiguous validated finalization.
3. Retain posting/document/service dates, original/functional currency, dimensions and source references.
4. Expose paged transaction filters and complete-journal drill-down with source-consistent counts and warnings.
...
- Sealed GL batch capability through shared import contracts.
- GeneralLedgerLineDto/JournalDto and paged browsing.
...
- Missing chunks, duplicate line keys and incomplete journal batches cannot pass.
- A replacement creates a new source revision without changing historical lines.
- Date/currency/dimension filters and full-journal totals agree.
...
|---|---|
| VP-036-AC03 | Importing/replacing GL creates a new source revision and invalidates affected reconciliations/packages without changing the original source rows. |

**Related original stories:** `VP-036`. [Full preserved wording and production interpretation](../../reference/auditsphere-r2r-reference-original-52-acceptance-criteria.md).

**Related integration journeys:** [R2R-AT-07](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-07), [R2R-AT-08](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-08), [R2R-AT-09](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-09).
