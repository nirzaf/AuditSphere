...
updated_at: ""
---
# T020 — Build opening completeness proofs and scoped source exports
...
Prove the full opening-plus-movement-to-closing bridge and complete Module 21’s consumer contracts.
...
- [T019 — Build versioned account mappings, manual splits and review](auditsphere-r2r-task-t019-versioned-account-mappings-splits-review.md)
...
1. Resolve compatible accepted opening/GL/closing sources, explicit cutoffs and the complete union of account identities.
2. Keep missing opening/coverage and pre-close versus post-close profiles explicit; do not assume zero.
3. Persist proof inputs, counts, residuals and read-snapshot identity through the durable calculation path.
4. Add bounded CSV/XLSX export and verify filters, totals and permissions match the visible source snapshot.
...
- [Module 21: exact input/output DTO fields and supporting request rules](../../modules/auditsphere-r2r-module-21-trial-balance-gl-contract.md#cqrs)
...
- CompletenessProofDto and exact source/mapping handoff.
- Scoped source exports and Module 21 integrated evidence.

**Direct consumers unlocked by this task:**

- [T021 — Build arbitrary-line adjustment drafts and submission](../06_M22_Adjustments/auditsphere-r2r-task-t021-arbitrary-line-adjustment-drafts-submission.md)
...
- GL-only accounts and missing openings cannot be omitted or marked complete.
- Partial batches, duplicates and mismatched period/currency block readiness.
- Exported values/counts reconcile and no client/firm ledger is posted.
...
|---|---|
| VP-036-AC01 | Given coherent opening balances, GL movements and closing TB, when completeness is calculated, then per-account residuals and source references reconcile. |
...
| VP-036-AC04 | Filters, source counts, drill-down and CSV export agree; the module never posts to client or firm books and handles the documented fixture size without freezing navigation. |

**Related original stories:** `VP-036`, `VP-037`. [Full preserved wording and production interpretation](../../reference/auditsphere-r2r-reference-original-52-acceptance-criteria.md).

**Related integration journeys:** [R2R-AT-01](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-01), [R2R-AT-02](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-02), [R2R-AT-09](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-09), [R2R-AT-15](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-15).
