...
**Related original stories:** `VP-041`. [Full preserved wording and production interpretation](../../reference/auditsphere-r2r-reference-original-52-acceptance-criteria.md).

**Related integration journeys:** [R2R-AT-14](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-14), [R2R-AT-17](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-17).

**Golden fixtures:** [GOLD-R2R-04](../../coverage/auditsphere-r2r-tracker-golden-fixtures.md#gold-r2r-04). Fixture use requires the original policy approval; the numbers are synthetic QA values.
