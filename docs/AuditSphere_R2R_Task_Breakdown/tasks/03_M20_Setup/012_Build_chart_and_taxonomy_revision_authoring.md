...
updated_at: ""
---
# T012 — Build chart and taxonomy revision authoring
...
Publish reusable but immutable chart/taxonomy configuration for subsequent source mappings.
...
- [T011 — Build accounting profiles, fiscal periods and reporting books](011_Build_accounting_profiles_fiscal_periods_and_reporting_books.md)
...
1. Reuse ClientChartVersion, ClientAccount, aliases and taxonomy records; do not create another account catalogue.
2. Implement hierarchy, posting-parent, leading-zero, stable identity and effective-date rules; serialize concurrent parent/publication changes.
3. Expose chart editing, aliases, comparison and explicit publication in the existing accounting workspace.
4. Use the approved policy for taxonomy authoring/publication. The blueprint has no separately enumerated taxonomy command; record an existing equivalent or obtain a contract decision before inventing one.
...
- Approved chart/taxonomy revision handoff and hierarchy UI.
- Source-located taxonomy capability/contract decision and database constraints.

**Direct consumers unlocked by this task:**

- [T013 — Build multidimensional accounting schema revisions](013_Build_multidimensional_accounting_schema_revisions.md)
...
- Duplicate normalized codes, cross-version parents and cycles fail.
- Concurrent publication has one winner or an explicit conflict.
- Historical package references continue to resolve the old chart.
...
|---|---|
| VP-034-AC02 | Duplicate account codes, invalid date ranges, hierarchy cycles and posting accounts used as parents are rejected. |
...
**Related integration journeys:** [R2R-AT-02](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-02), [R2R-AT-05](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-05), [R2R-AT-27](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-27).
