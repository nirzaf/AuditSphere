...
updated_at: ""
---
# T013 — Build multidimensional accounting schema revisions
...
Define and publish bounded accounting dimensions without an operational ERP.
...
- [T012 — Build chart and taxonomy revision authoring](012_Build_chart_and_taxonomy_revision_authoring.md)
...
1. Reuse or extend definitions/values for approved department, cost-centre and project-style dimensions.
2. Validate unique owner-scoped codes, effective dates, required values and immutable used revisions.
3. Expose DimensionSchemaEditor with explicit impact preview and independent publication where required by policy.
4. Make the selected schema available to source-import validators through the context contract.
...
- Published dimension schema and revision history.
- Schema validation and import-facing contract.

**Direct consumers unlocked by this task:**

- [T014 — Activate exact reporting contexts and verify Module 20 setup](014_Activate_exact_reporting_contexts_and_verify_Module_20_setup.md)
...
- An unknown or out-of-period nonblank dimension is not silently accepted.
- Published/used values cannot disappear from historical records.
- Changing dimension definitions invalidates affected current context applicability.
...
**Related integration journeys:** [R2R-AT-02](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-02), [R2R-AT-27](../../coverage/03_Integration_Journey_Tracking.md#r2r-at-27).
