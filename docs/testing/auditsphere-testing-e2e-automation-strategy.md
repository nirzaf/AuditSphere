...
Controlling requirements are the [system test contract, §44](../auditsphere-requirements-system-specification-current.md#s44), [CI/runtime contract, §45](../auditsphere-requirements-system-specification-current.md#s45), [accounting requirements](../auditsphere-accounting-module-requirements-current.md), [audit-workflow requirements](../task_breakdown/source/auditsphere-audit-source-workflow-gap-closure-user-stories-historical.md), and [M365 onboarding requirements](../auditsphere-m365-onboarding-user-stories.md). Requirement checkboxes and test titles alone do not establish end-to-end acceptance.
