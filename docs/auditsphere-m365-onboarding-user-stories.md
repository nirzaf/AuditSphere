...
**Suggested repository location:** `docs/requirements/auditsphere-m365-onboarding-user-stories.md`
...
```text
Implement docs/requirements/auditsphere-m365-onboarding-user-stories.md in nirzaf/AuditSphere. Read current AGENTS.md, auditsphere-requirements-system-specification-current.md and existing M365/auth/role/provider code first; reuse implemented behavior.
