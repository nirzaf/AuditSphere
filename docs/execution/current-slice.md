...
| Item | Observed value |
|---|---|
| Source implementation checkpoint | `master@5d32cf1` |
| Remote | `origin/master` includes source checkpoint `5d32cf1` |
| SDK | .NET 10; repository solution targets `net10.0` |
| Database | PostgreSQL 18.6 on loopback port 5433 for development only |
| Build | `dotnet build src/AuditSphereOps.Web/AuditSphereOps.Web.csproj --no-restore --configuration Release` at `5d32cf1` — passed, 0 warnings/errors; solution Release baseline passed at `4010963` |
| Tests | 213/213 passed, 0 skipped against PostgreSQL 18.6 at `5d32cf1` |
