...
- Ten applied migrations on `auditsphere`: `InitialCreate`, `TrialBalanceValidation`, `AccountingIntegrity`, `20260917104422_DurableOutbox`, `20260918041428_AuthorizationIntegrity`, `20260918083524_AdjustmentSourceBridge`, `20260918093347_PracticeCrmWorkflow`, `20260918095500_CrmSafetyInvariants`, `20260918111815_PracticeTimeBudgetWorkflow`, and `20260918115026_BillingArtifactWorkflow`. Verified no pending migrations.
- Build: zero warnings/errors. Full suite: 76/76 passed, zero skipped. The suite includes CRM and time/budget tests plus billing tests for finance-role separation, finance-profile gating, invoice/credit/receipt balance enforcement, concurrent source-allocation uniqueness, posted-history trigger rejection, and invalid legacy migration refusal.
...
## Checklist #8 — billing artifacts (implemented locally, commit `88e3409`)
