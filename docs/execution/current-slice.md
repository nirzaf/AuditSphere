...
| Remote | `origin/master` includes source checkpoint `b7305c1` |
| SDK | .NET 10; repository solution targets `net10.0` |
| Database | PostgreSQL 18.6 on loopback port 5433 for development only |
| Build | `dotnet build src/AuditSphereOps.Web/AuditSphereOps.Web.csproj --no-restore --configuration Release` at `b7305c1` — passed, 0 warnings/errors |
| Tests | 218/218 passed, 0 skipped against PostgreSQL 18.6 at `b7305c1` |
