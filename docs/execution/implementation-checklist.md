...
- **Next permitted step:** checklist #4 (synthetic identity + command-enforced authorization). No PR, merge, production deployment, or live-provider action was performed.