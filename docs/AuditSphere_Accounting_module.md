...
**Pinned review commit:** `dfc7563` (current accounting implementation including controlled XLSX formulas, deterministic DOCX/PDF exports, persisted and method-validated advanced-method schedules, the candidate advanced-method statement fixture and recorded IFRS method scope; detailed capability evidence remains in `docs/execution/current-slice.md`)
