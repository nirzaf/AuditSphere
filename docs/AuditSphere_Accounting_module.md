...
| G03 | Client grouping and ownership | Effective-dated group membership and versioned consolidation perimeter/ownership inputs exist. [R4] | Advanced NCI, acquisition, ownership-change, nested-group and associate methods remain explicit G17 scope; membership alone grants no access. | P1/P3 |
