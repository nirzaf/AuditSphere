...
**Pinned review commit:** `f861892` (generation-bound accounting evidence freshness)
...
- **R1:** GitHub `master` metadata and Domain/Application inventory at `f861892`.
...
https://github.com/nirzaf/AuditSphere/tree/f861892
