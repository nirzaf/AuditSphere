...
| G16 | Multi-currency | Approved rate sets/policies, pinned foreign-operation translation, maker/checker results and per-line FX lineage exist; deterministic calculators distinguish monetary remeasurement, translation and display conversion, with method-specific golden fixtures. [R11, R15] | Preserve rate provenance and applicability; nonexchangeable currencies and unsupported hyperinflation remain blocked, and a calculator alone does not activate a live reporting profile. | LOCAL_VERIFIED |
