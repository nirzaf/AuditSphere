...
**Pinned review commit:** `d098d50` (current accounting implementation including controlled XLSX formulas, deterministic DOCX/PDF exports, persisted and method-validated advanced-method schedules, guarded advanced current/comparative execution evidence, consolidation readiness UI, the candidate advanced-method statement fixture and recorded IFRS method scope; detailed capability evidence remains in `docs/execution/current-slice.md`)
