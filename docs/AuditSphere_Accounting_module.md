...
**Pinned review commit:** `c06277c` (method-acceptance, approved-component, stale-run publication and exact component-lineage gates)
...
| G16 | Multi-currency | Current TB import deliberately rejects mixed currencies. [R11] | Functional-currency datasets plus foreign amount/rate evidence; approved remeasurement and translation. | P4 |
| G17 | Group consolidation | No consolidation run/component/ownership/elimination/NCI model in inspected domain inventory; v5 excludes full consolidation initially. [R1–R2, R5] | New bounded consolidation module using approved immutable component packages. | P3/P4 |
...
- **R1:** GitHub `master` metadata and Domain/Application inventory at `c06277c`.
...
https://github.com/nirzaf/AuditSphere/tree/c06277c
