...
**Pinned review commit:** `0c6025c` (method-acceptance, approved-component, stale-run, exact component-lineage, bounded foreign-operation translation, explicit FX direction, group-revision, stale-scope-write, archive-lineage, group-roll-forward, source-bound reconciliation, reconciliation-item source binding, durable GL completeness and financial-package calculation gates)
...
- **R1:** GitHub `master` metadata and Domain/Application inventory at `0c6025c`.
...
https://github.com/nirzaf/AuditSphere/tree/0c6025c
