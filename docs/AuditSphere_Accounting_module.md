...
The `ccb01ea` web slice initially scoped Portfolio counters and release/package lists to active explicit grants; `60c7c68` preserves exact engagement-grant boundaries so an engagement-only grant cannot expand to sibling engagements.
