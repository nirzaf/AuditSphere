...
**Pinned review commit:** `54651db` (method-acceptance, approved-component, stale-run, exact component-lineage, bounded foreign-operation translation, explicit FX direction, group-revision, stale-scope-write, archive-lineage, group-roll-forward, source-bound reconciliation, reconciliation-item source binding, trial-balance, financial-package and adjustment-journal reporting-context binding, durable GL completeness, financial-package calculation and rendering gates)
