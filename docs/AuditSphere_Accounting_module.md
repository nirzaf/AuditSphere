...
**Pinned review commit:** `a07272f` (method-acceptance, approved-component, stale-run, exact component-lineage and bounded foreign-operation translation gates)
...
- **R1:** GitHub `master` metadata and Domain/Application inventory at `a07272f`.
...
- **R15:** `src/AuditSphereOps.Application/Accounting/CurrencyTranslationService.cs`, `ConsolidationService.cs` and `ConsolidationCalculator.cs`: pinned approved foreign-operation translation profile and deterministic per-line FX lineage.
...
https://github.com/nirzaf/AuditSphere/tree/a07272f
