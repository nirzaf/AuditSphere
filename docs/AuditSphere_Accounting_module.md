...
The `ccb01ea` web slice additionally scopes Portfolio counters and release/package lists to active explicit grants and shows actionable no-scope guidance.
