...
updated_at: ""
---
# T031 — Build equity-movement schedules
...
Explain equity movements independently of current profit and preserved prior-period adjustments.
...
- [T029 — Build canonical statement sets and exact line drill-down](../08_M24_Statements/auditsphere-r2r-task-t029-canonical-statement-sets-line-drilldown.md)
...
1. Persist opening equity, profit, OCI, contributions/distributions and approved prior-error/policy treatment.
2. Pin all source/policy/period references and distinguish ledger year-end profit transfers from current-period presentation.
3. Reconcile schedule lines to mapped statements and preserve predecessor versions.
4. Build equity editor and movement drill-down; use shared supplementary review in T033.
...
- Versioned equity schedule and reconciled statement contributions.
- Equity movements editor and provenance.

**Direct consumers unlocked by this task:**

- [T033 — Complete statement review and restatement lifecycle](auditsphere-r2r-task-t033-statement-review-restatement-lifecycle.md)
...
- GOLD-R2R-05 closes equity at 6,050.
- Opening error adjustment is not current-period profit.
- Profit already transferred into retained earnings is not counted again.
...
**Related integration journeys:** [R2R-AT-15](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-15), [R2R-AT-16](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-16), [R2R-AT-17](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-17).

**Golden fixtures:** [GOLD-R2R-05](../../coverage/auditsphere-r2r-tracker-golden-fixtures.md#gold-r2r-05). Fixture use requires the original policy approval; the numbers are synthetic QA values.
