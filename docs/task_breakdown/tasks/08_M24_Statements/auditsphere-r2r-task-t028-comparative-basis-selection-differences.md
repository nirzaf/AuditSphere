...
updated_at: ""
---
# T028 — Implement comparative-basis selection and historical differences
...
Pin exact comparative sources and distinguish issued, reclassified and restated presentations.
...
- [T027 — Build bounded statement-layout definitions and publication](auditsphere-r2r-task-t027-statement-layout-definitions-publication.md)
...
1. Resolve compatible current/prior contexts and exact approved prior result/source versions.
2. Represent missing comparative support as unavailable, never zero, and separate change/treatment classifications.
3. Persist selection/reason/evidence with prior-period impact and dependency currentness.
4. Build current/prior selector and difference preview; reserve approval of restatement cases for T033.
...
- Versioned comparative selection and difference DTO.
- Historical-current comparison UI.

**Direct consumers unlocked by this task:**

- [T029 — Build canonical statement sets and exact line drill-down](auditsphere-r2r-task-t029-canonical-statement-sets-line-drilldown.md)
...
- Replacing a prior mapping/source invalidates current comparative consumers without changing issued output.
- Incompatible currency/basis/period is rejected or explicitly bridged by approved policy.
- Missing prior data cannot produce a claimed complete comparative statement.
...
**Related integration journeys:** [R2R-AT-15](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-15), [R2R-AT-16](../../coverage/auditsphere-r2r-tracker-integration-journeys.md#r2r-at-16).
