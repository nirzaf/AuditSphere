...
**Authority:** Preserved architectural and scope clarifications. Does not override `AGENTS.md` or `docs/architecture/auditsphere-architecture-current-architecture.md`.
