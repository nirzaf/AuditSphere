[Master index](../auditsphere-r2r-index-task-breakdown.md) · [Original module in source](../source/auditsphere-r2r-source-blueprint-modules-20-26-historical.md#module-21)
...
**EXISTING/EXTEND:** `TrialBalanceDataset`, `TrialBalanceImportBatch`, `TrialBalanceRow`, existing source/GL import records, `MappingVersion`, `MappingAllocation`, opening/completeness records. Reuse the current import/profile/parser and normalized-digest contracts. Do not build a second TB table under a new module name. [R4](../reference/auditsphere-r2r-reference-standards-and-source-register.md#source-r4)[R7](../reference/auditsphere-r2r-reference-standards-and-source-register.md#source-r7)
