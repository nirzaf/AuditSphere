...
| <a id="e-old-aud"></a>[OLD-AUD](https://github.com/nirzaf/AuditSphere/blob/f64a1f4ef05bf0372cd60af5878031601a9dad61/docs/requirements/AuditSphere_Audit_Workflow_Gap_Closure_User_Stories.md) | `docs/requirements/AuditSphere_Audit_Workflow_Gap_Closure_User_Stories.md` | F — existing source / specification | Existing audit gap plan, AWP catalogue and AS-AUD story namespace; preserve every original entry and owner. |
