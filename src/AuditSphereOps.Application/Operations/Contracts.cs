...
public interface IAuditSphereDbContext : IAsyncDisposable
{
  ...
  DbSet<FinancialPackageArtifact> FinancialPackageArtifacts { get; }
  ...
  DbSet<FinancialPackageFxEffect> FinancialPackageFxEffects { get; }
  DbSet<FinancialPackageSeal> FinancialPackageSeals { get; }
  ...
  DbSet<PbcCommunication> PbcCommunications { get; }
...
public interface IClientAccountingDbContext : IAuditSphereDbContext
{
  ...
  DbSet<AdvancedConsolidationExecution> AdvancedConsolidationExecutions { get; }
