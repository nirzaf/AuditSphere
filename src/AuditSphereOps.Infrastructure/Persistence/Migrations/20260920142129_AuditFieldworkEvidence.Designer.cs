...
namespace AuditSphereOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920142129_AuditFieldworkEvidence")]
    partial class AuditFieldworkEvidence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuditSphereOps.Domain.Audit.AuditItemTest", b =>
                {
                    ...
                    b.ToTable("audit_item_tests", null, t =>
                        {
                            t.HasCheckConstraint("ck_audit_item_test_values", "revision > 0 AND length(trim(work_performed)) > 0 AND length(trim(evidence_references_json)) > 0 AND result IN ('PENDING','PASS','EXCEPTION','LIMITATION')");
                        });
                });
